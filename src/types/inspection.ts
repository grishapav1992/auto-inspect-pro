...
export const SECTION_DAMAGE_TAGS: Partial<Record<InspectionSection, string[]>> = {
  'body': ['Царапина', 'Скол', 'Вмятина', 'Потертость', 'Ржавчина', 'Коррозия', 'Перекрас', 'Частичный перекрас', 'Шпатлевка', 'Замена детали', 'Следы ремонта', 'Следы ДТП', 'Нарушены зазоры', 'Трещина', 'Скол краски', 'Отсутствует элемент'],
  'interior': ['Износ', 'Потертость', 'Порвано', 'Загрязнение', 'Пятна', 'Повреждение', 'Трещина', 'Сломано', 'Не работает', 'Отсутствует элемент', 'Следы ремонта'],
  'under-hood': ['Подтек масла', 'Подтек антифриза', 'Подтек жидкости', 'Коррозия', 'Следы ремонта', 'Следы демонтажа', 'Повреждение', 'Износ', 'Нестандартный элемент'],
  'technical': ['Износ', 'Шум', 'Вибрация', 'Течь', 'Повреждение', 'Требует замены', 'Не работает', 'Люфт', 'Стук'],
  'electrical': ['Не работает', 'Работает некорректно', 'Ошибка системы', 'Глючит', 'Повреждение', 'Следы ремонта'],
  'diagnostics': ['Есть ошибки', 'Сохраненные ошибки', 'Активные ошибки', 'Пробег не совпадает', 'Система неисправна'],
  'legal-check': ['Есть ограничения', 'Есть залог', 'Кредит', 'Лизинг', 'Работа в такси', 'ДТП', 'Страховые выплаты', 'Несоответствие VIN'],
  'test-drive': ['Шум', 'Вибрация', 'Пробуксовка', 'Рывки', 'Плохая управляемость', 'Стук', 'Проблема с тормозами'],
  'final-verdict': ['Отличное состояние', 'Хорошее состояние', 'Среднее состояние', 'Плохое состояние', 'Не рекомендуется к покупке', 'Рекомендуется к покупке'],
};
