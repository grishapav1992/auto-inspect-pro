export const DAMAGE_TAG_GROUPS = [
  {
    ...
    tags: [
      ...
      { id: "major_repaint", label: "Окрас большей части", emoji: "🖌️" },
      { id: "deep_deformation", label: "Глубокая деформация", emoji: "💥" },
      { id: "heavy_putty", label: "Шпатлёвка от 400мкм", emoji: "🧱" },
      { id: "scratch_over_10cm", label: "Царапина от 10см", emoji: "✏️" },
  ...
  },
  {
    ...
    tags: [
      { id: "scratch_5cm", label: "Царапина до 5 см", emoji: "✏️" },
      { id: "scratch_10cm", label: "Царапина до 10 см", emoji: "✏️" },
...
export const GLASS_DAMAGE_TAG_GROUPS = [
  ...
  },
  {
    ...
    tags: [
      ...
      { id: "glass_scratch", label: "Царапина", emoji: "✏️" },
      { id: "glass_tint", label: "Тонировка", emoji: "🕶️" },
...
export const LIGHTING_DAMAGE_TAG_GROUPS = [
  ...
  },
  {
    ...
    severity: "minor" as const,
    tags: [
      { id: "light_foggy", label: "Помутнение", emoji: "🌫️" },
      { id: "light_moisture", label: "Запотевание / влага", emoji: "💧" },
      { id: "light_scratch", label: "Царапина", emoji: "✏️" },
...
export const INTERIOR_MAIN_TAG_GROUPS = [
  ...
  },
  {
    ...
    tags: [
      ...
      { id: "int_scratch", label: "Царапины", emoji: "✏️" },
...
export const INTERIOR_DASHBOARD_TAG_GROUPS = [
  {
    ...
    tags: [
      ...
      { id: "dash_climate_fault", label: "Блок климата неисправен", emoji: "❄️" },
  ...
  },
  {
    ...
    severity: "minor" as const,
    tags: [
      { id: "dash_scratch", label: "Царапины", emoji: "✏️" },
      { id: "dash_scuff", label: "Потёртость", emoji: "🎡" },
      { id: "dash_pixel", label: "Битые пиксели / засветы", emoji: "🖥️" },
      { id: "dash_backlight", label: "Неисправна подсветка", emoji: "💡" },
      { id: "dash_disassembly", label: "Следы разбора", emoji: "🔩" },
      { id: "dash_icons_worn", label: "Стёрты пиктограммы", emoji: "🏷️" },
    ],
  },
] as const;
...
export const DIAGNOSTICS_TAG_GROUPS = [
  {
    ...
    tags: [
      ...
      { id: "diag_transmission_error", label: "Ошибка АКПП/КПП", emoji: "⚙️" },
  ...
  },
  {
    ...
    severity: "minor" as const,
    tags: [
      { id: "diag_frozen_error", label: "Замороженная ошибка", emoji: "❄️" },
      { id: "diag_warning_engine", label: "Предупреждение двигателя", emoji: "🔧" },
      { id: "diag_warning_transmission", label: "Предупреждение АКПП/КПП", emoji: "⚙️" },
...
export const TD_ENGINE_TAGS = [
  { id: "td_engine_vibration", label: "Вибрация двигателя", emoji: "〰️" },
  { id: "td_engine_knock", label: "Посторонний стук", emoji: "🔊" },
  { id: "td_engine_power_loss", label: "Потеря мощности", emoji: "⬇️" },
  { id: "td_engine_misfire", label: "Пропуски зажигания", emoji: "⚡" },
  { id: "td_engine_smoke", label: "Дым из выхлопной", emoji: "💨" },
  { id: "td_engine_overheat", label: "Перегрев", emoji: "🌡️" },
  { id: "td_engine_idle", label: "Нестабильный холостой ход", emoji: "📉" },
] as const;

export const TD_GEARBOX_TAGS = [
  { id: "td_gear_hard_shift", label: "Тугое переключение", emoji: "⚠️" },
  { id: "td_gear_delay", label: "Задержка переключения", emoji: "⏱️" },
  ...
  { id: "td_gear_vibration", label: "Вибрация на ходу", emoji: "〰️" },
] as const;

export const TD_STEERING_TAGS = [
  { id: "td_steer_play", label: "Люфт руля", emoji: "↔️" },
  { id: "td_steer_pull", label: "Увод в сторону", emoji: "↗️" },
  { id: "td_steer_noise", label: "Шум при повороте", emoji: "🔊" },
  { id: "td_steer_heavy", label: "Тяжёлый руль", emoji: "💪" },
  { id: "td_steer_vibration", label: "Вибрация руля", emoji: "〰️" },
] as const;

export const TD_RIDE_TAGS = [
  { id: "td_ride_knock", label: "Стук подвески на ходу", emoji: "🔊" },
  { id: "td_ride_sway", label: "Раскачка кузова", emoji: "〰️" },
  { id: "td_ride_drift", label: "Снос оси", emoji: "↗️" },
  { id: "td_ride_bounce", label: "Пробой подвески", emoji: "⬇️" },
] as const;

export const TD_BRAKE_RIDE_TAGS = [
  { id: "td_brake_pull", label: "Увод при торможении", emoji: "↗️" },
  { id: "td_brake_vibration", label: "Вибрация при торможении", emoji: "〰️" },
  { id: "td_brake_long", label: "Длинный ход педали", emoji: "⬇️" },
  { id: "td_brake_squeal", label: "Скрип тормозов", emoji: "🔊" },
  { id: "td_brake_abs", label: "Срабатывание ABS на ровной", emoji: "⚠️" },
] as const;
