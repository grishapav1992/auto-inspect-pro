...
const ENGINE_TAGS: DiagTagGroup = [
  {
    ...
    tags: [
      ...
      { id: "eng_err_rough", label: "Неровная работа", emoji: "〰️" },
      { id: "eng_err_mixture", label: "Ошибка по смеси", emoji: "⚗️" },
      { id: "eng_err_fuel_pressure", label: "Низкое давление топлива", emoji: "⛽" },
      { id: "eng_err_turbo", label: "Ошибка турбины", emoji: "🌀" },
      { id: "eng_err_overboost", label: "Передув", emoji: "⬆️" },
      { id: "eng_err_underboost", label: "Недодув", emoji: "⬇️" },
      { id: "eng_err_vvt", label: "Ошибка фаз", emoji: "⚙️" },
      { id: "eng_err_timing", label: "Ошибка ГРМ", emoji: "⏱️" },
    ],
  },
  {
    ...
    tags: [
      ...
      { id: "eng_warn_unstable", label: "Нестабильная работа", emoji: "〰️" },
...
const TRANSMISSION_TAGS: DiagTagGroup = [
  {
    ...
    severity: "serious",
    tags: [
      { id: "trans_err_general", label: "Ошибки АКПП", emoji: "⚙️" },
      ...
      { id: "trans_err_dsg", label: "Ошибка DSG", emoji: "⚙️" },
  ...
  },
  {
    ...
    severity: "minor",
    tags: [
      { id: "trans_warn_general", label: "Предупреждение по АКПП", emoji: "⚙️" },
      { id: "trans_warn_check", label: "Требуется проверка АКПП", emoji: "🔍" },
      { id: "trans_warn_shift", label: "Есть замечания по переключениям", emoji: "↕️" },
...
const BRAKES_CHASSIS_TAGS: DiagTagGroup = [
  {
    ...
    tags: [
      ...
      { id: "brake_err_epb", label: "Ошибка EPB", emoji: "🅿️" },
...
const ELECTRIC_TAGS: DiagTagGroup = [
  {
    ...
    tags: [
      ...
      { id: "elec_err_open", label: "Обрыв цепи", emoji: "✂️" },
      { id: "elec_err_can", label: "Ошибка CAN", emoji: "🔗" },
      { id: "elec_err_comm", label: "Потеря связи", emoji: "📡" },
      { id: "elec_err_ecu", label: "Ошибка блока управления", emoji: "🖥️" },
    ],
  },
  {
    title: "Предупреждения",
